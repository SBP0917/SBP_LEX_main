...
| AP-05 | V2 product name, FastAPI launcher, public `/v2/evaluate` envelope and compatibility entrypoints | `IMPLEMENTATION_DEFINED_V2` | Defined by `README.md`, `main.py`, `Procfile`, `requirements.lock` and the current runner source. This is current repository construction, not patent provenance. |
