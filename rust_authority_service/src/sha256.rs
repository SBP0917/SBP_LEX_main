...
mod tests {
    ...
    fn matches_nist_empty_and_abc_vectors() {
        assert_eq!(
            digest(b""),
            decode_lower_hex_32("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")
                .expect("vector")
        );
        assert_eq!(
            digest(b"abc"),
            decode_lower_hex_32("ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad")
                .expect("vector")
        );
    }
}
